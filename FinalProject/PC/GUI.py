...
class ScriptMode:
    ...
    def __init__(self, master):
        ...
        self.translated_text_label = ttk.Label(self.top, text="Execute Script")
        self.translated_text_label.grid(row=1, column=3, padx=10, pady=5, sticky='w')
        ...
        self.load_button.grid(row=3, column=1, columnspan=2, padx=10, pady=10,
                              sticky='ew')  # Center under the two text widgets
        ...
        self.back_button.grid(row=4, column=0, columnspan=4, padx=10, pady=10,
                              sticky='ew')  # Spanning the entire lower row
    ...
    def load_file_content(self, file_path, index):
        def run():
            ...
            translated_content = bytes('\n' + self.translated_contents[index] + 'Z', 'utf-8')  # Append 'Z' end marker
